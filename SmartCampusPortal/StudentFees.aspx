<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentFees.aspx.cs" Inherits="SmartCampusPortal.StudentFees" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="main-card">
            <h2 class="section-title">My Fee Details</h2>
            <asp:GridView ID="gvFees" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped">
                <Columns>
